        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <h4 class="text-primary mb-4"><?= $getDataWeb->website_name;?></h4>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="<?= base_url('Kontak')?>">About Us</a>
                    <a class="btn btn-link" href="<?= base_url('Kontak')?>">Contact Us</a>
                    <a class="btn btn-link" href="">Our Services</a>
                    <a class="btn btn-link" href="">Terms & Condition</a>
                    <a class="btn btn-link" href="<?= base_url('Kontak')?>">Support</a>
                </div>
                <div class="col-lg-3 col-md-6">

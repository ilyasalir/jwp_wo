                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                    ...
                                    class="fs-4 text-white">Selamat datang di JWP Wedding Organizer!</strong></p>
                                    <h1 class="display-1 text-dark mb-4 animated zoomIn">Mengabadikan Setiap Pernikahan Anda</h1>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="section-title text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
                <p class="fs-1 fw-bold text-primary">Katalog</p>
                <h1 class="display-6">Dapatkan Pilihan Paket Anda </h1>
            </div>
            <div class="row g-4">
                <?php
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="store-item position-relative text-center">
                        ...
                        <div class="store-overlay">
                            <a href="<?= base_url('Beranda/detail?id=') . $row->catalogue_id; ?>" class="btn btn-primary rounded-pill py-2 
                            px-4 m-2">More Detail <i class="fa fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
                <?php endforeach ?>

  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-51" href="index.html"><img src="<?= base_url('assets/landing') ?>/img/logo2.png" class="mr-1" alt="logo"/>JWP WO</a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <?php $this->load->view($page);?>
          ...
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2024. JWP WO</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
